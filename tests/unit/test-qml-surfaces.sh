...
contains src/shell/FileBrowserWindow.qml 'objectName: "bundleInstallDialog"'
contains src/shell/FileBrowserWindow.qml 'property QtObject bundleInstaller'
contains src/shell/FileBrowserWindow.qml 'readonly property bool bundleInstallerAvailable: bundleInstaller !== null'
contains src/shell/FileBrowserWindow.qml 'bundleInstaller.bundleDetails(path)'
contains src/shell/FileBrowserWindow.qml 'bundleInstaller.installBundle(bundleInstallDialog.itemPath)'
...
contains src/shell/ApplicationOverview.qml 'bundleInstaller.removeBundle(applicationPinMenu.bundleIdentifier)'
contains src/shell/main.cpp 'northstarApplicationBundleInstaller'
contains src/shell/main.cpp '"bundleInstaller", QVariant::fromValue<QObject *>(&applicationBundleInstaller)'
