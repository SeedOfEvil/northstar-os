...
contains src/shell/main.cpp 'constexpr int PanelHeight = 46;'
contains src/shell/main.cpp 'constexpr int DockHeight = 126;'
...
contains src/shell/DockWindow.qml 'return -6'
contains src/shell/DockWindow.qml 'dockContent.implicitWidth + 28'
...
contains src/shell/DockWindow.qml 'return groups.length === 0 ? 0'
...
contains src/ui/NativeWindowMoveHandler.qml 'signal moveStarted()'
contains src/ui/NativeWindowResizeHandler.qml 'root.window.startSystemResize(parent.edges)'
contains src/ui/NativeWindowResizeHandler.qml 'edges: Qt.LeftEdge | Qt.TopEdge'
contains src/ui/NativeWindowResizeHandler.qml 'edges: Qt.RightEdge'
contains src/ui/NativeWindowResizeHandler.qml 'edges: Qt.BottomEdge'
...
contains src/shell/QuickSettings.qml 'onMoveStarted: quickSettingsDrag.hasCustomPosition = true'
...
contains src/shell/QuickSettings.qml 'actionable: !!quickSettings.controller && quickSettings.controller.wifiWritable'
contains src/shell/QuickSettings.qml 'actionable: !!quickSettings.controller && quickSettings.controller.bluetoothWritable'
...
contains src/shell/QuickSettings.qml 'height: Math.min(metrics.quickSettingsHeight,'
contains src/shell/QuickSettings.qml 'settingsWindow.openSettings()'
contains src/shell/QuickSettings.qml 'systemMenu.openMenu()'
contains src/shell/ShellWindow.qml 'controller: northstarQuickSettingsController'
contains src/shell/ShellWindow.qml 'systemMenu: systemMenu'
...
contains src/shell/ApplicationOverview.qml 'NorthstarWindowTitleBar {'
contains src/shell/ApplicationOverview.qml 'NativeWindowResizeHandler {'
...
contains src/shell/FileBrowserWindow.qml 'text: "Devices..."'
contains src/shell/FilesRemovableDevicesDialog.qml 'objectName: "removableDevicesDialog"'
contains src/shell/FilesRemovableDevicesDialog.qml 'objectName: "removableBrowseAction"'
contains src/shell/FilesRemovableSidebar.qml 'objectName: "sidebarRemovableOpen"'
contains src/shell/FilesRemovableSidebar.qml 'objectName: "sidebarRemovableUnmount"'
contains src/shell/FileBrowserWindow.qml 'objectName: "removableSidebarRefresh"'
contains src/shell/FilesRemovableDevicesDialog.qml 'else dispatchStorageRequest()'
contains src/shell/FilesRemovableDevicesDialog.qml '"Mount & Browse"'
contains src/shell/FilesRemovableDevicesDialog.qml 'partition.identity === identity && partition.browseReady'
contains src/shell/FilesRemovableDevicesDialog.qml 'ownerWindow.volumeController.scanRemovable()'
contains src/shell/FilesRemovableDevicesDialog.qml 'textFormat: Text.PlainText'
contains src/shell/FileBrowserWindow.qml 'nameDialog.nameText = mode === "rename"'
contains src/shell/FilesNameDialog.qml 'property alias nameText: nameField.text'
contains src/shell/FilesNameDialog.qml 'ownerWindow.fileBrowserController.renameEntry(originalPath, nameField.text)'
contains src/shell/FilesNameDialog.qml 'Qt.callLater(function() { nameDialog.open() })'
contains src/shell/FilesPasteConflictDialog.qml 'ownerWindow.fileBrowserController.cancelConflict()'
contains src/shell/FilesPasteConflictDialog.qml 'ownerWindow.fileBrowserController.pasteClipboard("keepBoth")'
contains src/shell/FilesTrashDialog.qml 'ownerWindow.fileBrowserController.moveToTrash(itemPath)'
contains src/shell/FilesRestoreDialog.qml 'ownerWindow.fileBrowserController.restoreEntry(itemPath)'
contains src/shell/FilesEmptyTrashDialog.qml 'ownerWindow.fileBrowserController.emptyTrash()'
contains src/shell/FileBrowserWindow.qml 'id: bundleInstallDialog'
contains src/shell/FilesBundleInstallDialog.qml 'objectName: "bundleInstallDialog"'
contains src/shell/FileBrowserWindow.qml 'applicationLauncher.applicationBundleDetails(path)'
contains src/shell/FilesBundleInstallDialog.qml 'applicationLauncher.installApplicationBundle('
contains src/shell/FilesBundleInstallDialog.qml '? bundleInstallDialog.details.displayName + " was installed"'
contains src/shell/FilesBundleInstallDialog.qml 'visible: !bundleInstallDialog.operationComplete'
contains src/shell/FileBrowserWindow.qml 'files.isApplicationBundle(files.selectedEntry) ? "Install App" : "Open"'
contains src/shell/ApplicationOverview.qml 'text: "Application Information..."'
contains src/shell/ApplicationOverview.qml 'objectName: "applicationOverview"'
contains src/shell/ApplicationOverview.qml 'visible: applicationPinMenu.userInstalled'
contains src/shell/ApplicationOverview.qml 'applicationLauncher.removeApplicationBundle('
contains src/shell/main.cpp 'applicationLauncher.setApplicationBundleInstaller(&applicationBundleInstaller)'
...
contains src/shell/SettingsWindow.qml 'Math.max(minimumSurfaceHeight, metrics.settingsHeight)'
...
contains src/shell/main.cpp 'controllerModesetInProgress = true'
contains src/shell/main.cpp 'if (controllerModesetInProgress)'
contains src/shell/main.cpp 'outputRefreshTimer.stop()'
...
contains src/shell/main.cpp '"remapIfPending"'
...
contains src/ui/AuroraSlider.qml 'implicitHeight: 32'
contains src/ui/NorthstarSystemIcon.qml 'Canvas {'
contains src/ui/NorthstarSystemIcon.qml 'function wifi(ctx)'
contains src/ui/NorthstarSystemIcon.qml 'function settings(ctx)'
contains src/ui/AuroraMetrics.qml 'readonly property int settingsWidth: 925'
contains src/ui/AuroraMetrics.qml 'readonly property int quickSettingsWidth: 408'
contains src/ui/AuroraMetrics.qml 'readonly property int dockWidth: 800'
contains src/ui/northstarui.cpp '"Northstar.Ui", 1, 0, "AuroraMetrics"'
if grep -F 'sourceClipRect' "$ROOT/src/ui/NorthstarSystemIcon.qml" >/dev/null 2>&1; then
    fail 'system icons must not depend on runtime bitmap cropping'
fi
contains src/ui/NorthstarIcon.qml 'property real cropFactor: 0.88'
...
contains src/ui/AuroraComboBox.qml 'ComboBox {'
contains src/shell/SettingsWindow.qml 'NorthstarSystemIcon {'
contains src/shell/QuickSettings.qml 'iconName: "wifi"'
contains src/shell/ShellWindow.qml 'model: ["brightness", "wifi", "sound"]'
contains src/ui/NorthstarSystemIcon.qml 'property color strokeColor:'
contains src/ui/AuroraActivityIcon.qml 'property string mode: "work"'
contains apps/wifi/WifiWindow.qml 'mode: "wifi"'
contains apps/bluetooth/BluetoothWindow.qml 'mode: "bluetooth"'
...
contains src/shell/FilesBundleInstallDialog.qml 'bundleInstallDialog.details.webNotice'
contains src/shell/FilesBundleInstallDialog.qml 'objectName: "installDialogScroll"'
