...
contains src/shell/FileBrowserWindow.qml 'applicationLauncher.installApplicationBundle('
contains src/shell/FileBrowserWindow.qml '? bundleInstallDialog.details.displayName + " was installed"'
contains src/shell/FileBrowserWindow.qml 'visible: !bundleInstallDialog.operationComplete'
