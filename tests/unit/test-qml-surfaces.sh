...
contains src/shell/DockWindow.qml 'dockContent.implicitWidth + 24'
...
contains src/shell/SettingsWindow.qml 'Math.max(minimumSurfaceHeight, 680)'
...
contains src/ui/NorthstarSystemIcon.qml 'property real cropFactor: 0.62'
contains src/ui/NorthstarSystemIcon.qml 'property bool monochrome: false'
contains src/ui/NorthstarSystemIcon.qml 'colorizationColor: icon.monochromeColor'
contains src/ui/NorthstarIcon.qml 'property real cropFactor: 0.76'
...
contains src/ui/NorthstarSystemIcon.qml 'northstar-system-icons-aurora-light.png'
