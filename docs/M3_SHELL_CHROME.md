...
- The top bar carries the Northstar mark, Desktop/Files/Apps navigation, a
  global application search entry point, notification-center access,
  quick-settings access, and the clock.
...
1. The top bar shows the Northstar mark, navigation, search, notifications,
   quick settings, and clock without covering one another.
