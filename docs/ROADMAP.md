...
3. **Build the M4 package-trust foundation.** Validate the repository policy
   contract first, then define the Northstar Ports and Poudriere inputs, signed
