...
| M4 package trust | Pinned Ports/Poudriere inputs, signed repository metadata, package provenance, read-only/update-plan behavior, and no unauthorized mutation |
