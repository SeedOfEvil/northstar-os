...
| M3 desktop acceptance | Files mutation and Trash recovery, live Desktop Icons create/delete/rename/open/restore, associations/Open With, search, mounted-volume boundaries, overview, keyboard mappings, Files-to-Apps launch, app-bundle provenance, and settings persistence |
...
| M3 desktop | File operations, live branded Desktop Icons, settings persistence, user-scoped file associations, home search, mounted-volume locations, overview, Files-to-Apps drag-and-drop, project-owned menu, validated app-bundle provenance |
