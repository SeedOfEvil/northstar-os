...
| M3 desktop acceptance | Files mutation and Trash recovery, associations/Open With, search, mounted-volume boundaries, overview, keyboard mappings, Files-to-Apps launch, Desktop-folder icon projection and position persistence, app-bundle provenance, and settings persistence |
