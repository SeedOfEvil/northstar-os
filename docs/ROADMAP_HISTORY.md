# Northstar roadmap history

> Archived on 2026-08-25. This is the detailed milestone narrative that grew
> alongside M0-M7 implementation. It is retained for provenance; current
> status and next work are maintained in [`ROADMAP.md`](ROADMAP.md).
