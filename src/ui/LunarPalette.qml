...
QtObject {
    ...
    readonly property color panel: darkMode ? "#e8122238" : "#eef9fcff"
    readonly property color panelStrong: darkMode ? "#f20b1728" : "#f9fcffff"
    readonly property color dockGlass: darkMode ? "#b3122238" : "#c8f8fcff"
    readonly property color dockGlassEdge: darkMode ? "#53647f9d" : "#789ab4cf"
    readonly property color raised: darkMode ? "#d61a2b42" : "#e2ecf7"
    readonly property color raisedHover: darkMode ? "#ee243c59" : "#d4e6f8"
    readonly property color field: darkMode ? "#c00d1b2d" : "#edf3fa"
